...
public class DriverManager {
	...
	public static WebDriver createInstance(String browserName) {
		...
		case "FIREFOX":
			System.setProperty("webdriver.gecko.driver",
					"drivers/windows/fireFox/geckodriver.exe");
		...
		case "IE":
			System.setProperty("webdriver.ie.driver",
					"drivers/windows/IE/IEDriverServer.exe");
		...
		case "CHROME":
			System.setProperty("webdriver.chrome.driver",
					"drivers/windows/chrome/chromedriver.exe");
		...
		case "EDGE":
			System.setProperty("webdriver.edge.driver",
					"drivers/windows/edge/MicrosoftWebDriver.exe");
	...
	//	localDriver.manage().deleteAllCookies();
	 ...
	 public void waitUntilPageIsLoadded() {
	        new WebDriverWait(pageObjectsFactory.PageFactory.instance().getWebDriver(), timeOut).until(
